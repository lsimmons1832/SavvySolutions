...
namespace Savvy.Controllers
{
    ...
    public class StylistController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StylistID,Salon,Address1,Address2,City,State,Zip")] Stylist stylist)
        {
            var currentUser = User.Identity.GetUserId().ToString();
            stylist.User = db.Users.Find(currentUser);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StylistID,Salon,Address1,Address2,City,State,Zip")] Stylist stylist)
        {
            if (ModelState.IsValid)
            {
